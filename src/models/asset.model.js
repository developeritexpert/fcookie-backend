...
const AssetSchema = new mongoose.Schema(
  {
    ...
    // For unlimited key:value specs
    // Example: brand = Panini, year = 2024, card_no = #10
    // -------------------------------
    attributes: [
      {
    ...
    // -------------------------------
    // GRADING INFORMATION (NEW)
    // -------------------------------
    grading: {
      grader: { type: String },         // PSA, BGS, SGC
      grade: { type: String },          // 9, 9.5, 10
      cert_number: { type: String },    // PSA Certification #
      population: { type: Number },     // Population report
    },
    ...
    currency: {
      ...
      default: CONSTANT_ENUM.CURRENCY.USD, // FIXED (you had a typo)
    },
